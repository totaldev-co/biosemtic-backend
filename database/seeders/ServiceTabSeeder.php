    ...
    public function run(): void
    {
        $tabs = [
            ...
            [
                ...
                'footer_text' => 'Contamos con los mejores repuestos en el mercado y reparaciones en tiempo record.',
